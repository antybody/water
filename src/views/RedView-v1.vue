   ...
   data(){
       return {
           clists:[
                ...
                {href:'/redsyd',img:'wt-bar-i-46 wt-bar-5',title:'水源地'}, {href:'/redsgnq',img:'wt-bar-i-46 wt-bar-6',title:'水功能区'},
...
<style>
  ...
  .wt-tab-lists a{
      ...
      width:10.3125rem;line-height: 4.375rem;
      height: 4.375rem;margin:0.125rem 0.5rem;
      padding:0 0.625rem;
