                ...
                <div class="wt-list-info">
                    <div class="wt-list-lineover">
                        ...
                        <p class="g-overflow">
                           ...
                           <input id="imgupload" capture="camera" class="input-add-img" ref="inputer"
                                  multiple="multiple" @change="changeImg($event)" type="file" accept="image/*"/>
                        </span>
                             </span>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            formSubmit() {
                //必须上传图片
                if (this.imgArray.length === 0) this.$layer.msg("请上传现场图片！");
                //获取所有checked的input
