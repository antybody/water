...
const state = {
    ...
    queryMenu:[{title:'主导功能',ol:'主导功能',select:'',key:'zdgn',type:'checkbox',children:[
                  {title:'不限',key:'-1',checked:true},{title:'市级',key:'1',checked:false},{title:'市级',key:'2',checked:false}]},
               {title:'目标水质',ol:'目标水质',select:'',key:'fzdw',type:'checkbox',children:[
                  {title:'不限',key:'-1',checked:true},{title:'市级',key:'1',checked:false},{title:'市级',key:'2',checked:false}]},
               {title:'水体类型',ol:'取水用途',select:'',key:'qsyt',type:'checkbox',children:[
                  {title:'不限',key:'-1',checked:true},{title:'市级',key:'1',checked:false},{title:'市级',key:'2',checked:false}]}
             ],
    loading:true,
    pageNum:10,
