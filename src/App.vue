<template>
    <container fill direction="column">
        <tabbar slot="tabbar" class="am-view-push">
            <tabbar-item icon="home" title="首页" @tabbarItemClick="tabbarItemClick('redv1')"></tabbar-item>
            ...
            <tabbar-item active icon="person" title="我的" @tabbarItemClick="tabbarItemClick('home')"></tabbar-item>
        </tabbar>
    </container>
</template>
