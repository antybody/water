...
<style>
    ...
    .yo-scroll .inner .nullData {//暂无更多数据样式
            font-size: 26px;
            color: #999999;
            height: 100px;
            line-height: 100px;
    ...
    .yo-scroll .inner .down-tip,.yo-scroll .inner .refresh-tip,.yo-scroll .inner .up-tip {
            display: none;
    }
    .yo-scroll .inner .up-tip:before,.yo-scroll .inner .refresh-tip:before {
            content: '';
    ...
    .yo-scroll .inner .up-tip:before {
            background: url(../../statics/images/down-logo.png) no-repeat center;
    }
    .yo-scroll .inner .refresh-tip:before {
            background: url(../../statics/images/refresh-logo.gif) no-repeat center;
    }
    .yo-scroll .inner {
        position: absolute;
        top: -5rem;
