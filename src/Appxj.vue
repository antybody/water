<template>
    <container fill direction="column">
        <tabbar slot="tabbar" class="am-view-push">
            <tabbar-item v-show="isShowB1" active icon="home" title="首页"
                         @tabbarItemClick="tabbarItemClick('redv1')"></tabbar-item>
            <!-- <tabbar-item icon="bars" title="三条红线" href="/redv1"></tabbar-item> -->
            <tabbar-item v-show="isShowB2" icon="more" title="管理考核"
                         @tabbarItemClick="tabbarItemClick('check')"></tabbar-item>
            <!--
